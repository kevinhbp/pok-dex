...
object AppDependencies {
  ...
  val debugLibs = arrayListOf<String>().apply {
    add(composeUiTooling)
    add(composeUiTestManifest)
  }

  val dependencyInjectionComposeLibraries = arrayListOf<String>().apply {
    add(koinCore)
    add(koinAndroid)
    add(koinCompose)
  }
  ...
  private const val composeMaterial = "androidx.compose.material:material:${Versions.material}"
  private const val composeMaterial3 = "androidx.compose.material3:material3:${Versions.material3}"
  private const val composeMaterialIcons = "androidx.compose.material:material-icons-core:1.3.1"
  private const val composeMaterialIconsExt = "androidx.compose.material:material-icons-extended:1.3.1"
  private const val composeUiToolingPreview = "androidx.compose.ui:ui-tooling-preview:${Versions.composeVersion}"
  ...
  private const val composeUiTest = "androidx.compose.ui:ui-test-junit4:${Versions.composeVersion}"
  private const val composeUiTooling = "androidx.compose.ui:ui-tooling:${Versions.composeVersion}"
  private const val composeUiTestManifest = "androidx.compose.ui:ui-test-manifest:${Versions.composeVersion}"
  ...
  private const val koinAndroid = "io.insert-koin:koin-android:${Versions.koinAndroid}"
  private const val koinCompose = "io.insert-koin:koin-androidx-compose:${Versions.koinCompose}"
...
fun DependencyHandler.implementationDebug(list: List<String>) {
  list.forEach { dependency ->
